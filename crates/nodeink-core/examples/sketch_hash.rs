use nodeink_core::{
    DEFAULT_ELEMENT_SIZE, DEFAULT_INK_COLOR, DEFAULT_RECTANGLE_STROKE_COLOR, ElementRecordV1,
    Engine, FillV1, NodeInkDocumentV1, RectElementV1, RenderProfileV1, SketchFillStyleV1,
