...
- [x] Add Schema V6 curved Line/Arrow editing with a circular midpoint bend handle, persistent quadratic geometry, tangent-correct arrowheads, matching bounds/hit testing, and one-Transaction Undo/Redo; keep Connector binding and routing separate.
- [x] Specialize Text resize into product-level width/font-size semantics and complete keyboard/screen-reader access for transform handles.
...
---
*Last updated: 2026-07-23 | Reason: complete semantic Text resize and shared accessible selection handles*
