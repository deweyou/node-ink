...
- [ ] Productize the S2 freehand transport as a visible shared tool, reusing the same Rust-owned Selection and Transaction path after stroke commit.
...
---
*Last updated: 2026-07-22 | Reason: complete Phase 1A single selection and route the next visible tool work to freehand*
